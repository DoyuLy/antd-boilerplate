...
export const ERR_TOKEN_NEED_REFRESH = -999
...
export async function login(email: string, password: string, remember: boolean = true, app: string = APP) {
    let url = '/auth/login'
    let data = {
        email,
        password,
    ...
    myHeaders.set('X-Request-With', 'cp-web')
